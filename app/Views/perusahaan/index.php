											...
											<?php else : ?>
												...
												foreach ($perusahaan as $key => $value) : ?>
													<tr class="border-bottom-secondary">
														...
														<td><?= $value->alamat ?></td>
														<td>
															<button type="button" class="btn btn-primary btn-sm" onclick="openModal('<?= $value->id ?>','<?= $value->nama ?>','<?= $value->tgl_kerja_sama ?>','<?= $value->alamat ?>')">
																Edit
															</button>
...
<script type="text/javascript">
	function openModal(id, nama, tgl, alamat) {
		$("#id").val(id);
		$("#nama").val(nama);
		$("#tgl").val(tgl);
		$("#alamat").val(alamat);
